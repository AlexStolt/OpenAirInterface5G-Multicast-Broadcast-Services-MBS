...
typedef struct {
  ...
  bool retransmission;
  int mbms_pucch_allocation;

  // For the experiments
  int rb_allocation_stats;
  int rb_reallocation_stats;
  int transmission_data_available_slots;
  int retransmission_data_available_slots;
  int unavalable_cce_slots; 
  int unavalable_harq_slots; 
  int unavalable_pucch_slots; 
...
extern NR_UE_info_t *mbms_tunnel;
