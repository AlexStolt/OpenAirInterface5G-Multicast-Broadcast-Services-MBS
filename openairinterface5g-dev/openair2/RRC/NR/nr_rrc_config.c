                                                   ...
                                                   const nr_mac_config_t *configuration)
{
  ...
  LOG_D(NR_MAC, "[AlexStolt]: Computing CORSET based on curr_bwp %d bitmap %lx\n", curr_bwp, bitmap);
  ...
  LOG_D(NR_MAC, "[AlexStolt]: Computing Search Space based on coreset->controlResourceSetId %ld\n", coreset->controlResourceSetId);
